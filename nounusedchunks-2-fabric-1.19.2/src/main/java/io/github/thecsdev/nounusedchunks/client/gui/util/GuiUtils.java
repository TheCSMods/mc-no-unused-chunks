...
{
	// ==================================================
	private final static MinecraftClient MC;
	static { MC = MinecraftClient.getInstance(); }
	private GuiUtils() {}
	// ==================================================
	...
	public static void drawTooltip(MatrixStack matrices, int mouseX, int mouseY, float delta, Text text)
	{
		...
		{
			drawTextWithShadow(matrices, tr, Text.literal(line), mouseX + 5, mouseY + 5 + lineY, COLOR_WHITE);
